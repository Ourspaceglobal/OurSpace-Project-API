...
class ApartmentBookingNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
            ->line(
                "{$this->apartmentRental->user->full_name} has booked apartment: "
                . "{$this->apartmentRental->apartment->name} to start "
    ...
    public function toArray($notifiable)
    {
        return [
            'status' => true,
            'message' => "{$this->apartmentRental->user->full_name} has booked apartment: "
                . "{$this->apartmentRental->apartment->name} to start "
                . $this->apartmentRental->started_at->isoFormat('MMMM Do YYYY'),
        ];
    }
